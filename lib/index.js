...
const BroadcastTask = koishi_1.Schema.object({
    times: koishi_1.Schema.string().description('触发时间 (事列列表, 推荐格式: HH:mm,HH:mm)').default('09:30'),
    ...
    targetIds: koishi_1.Schema.string().description('目标ID列表 (事列列表, 需要用逗号隔开)').default(''),
